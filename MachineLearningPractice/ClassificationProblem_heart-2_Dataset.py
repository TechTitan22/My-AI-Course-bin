...
df = pd.read_csv("MachineLearningPractice/heart-2.csv")

print("Dataset shape:", df.shape)           # Dataset shape: (1025, 14)
print(df.head())
...
# Feature columns             
feature_names = df.drop(columns=["thalach", target_column]).columns

# Features (X) and Target (y)
X = df[feature_names].copy()
y = df[target_column].copy()

print("X shape:", X.shape)   # X shape: (1025, 12)
print("y shape:", y.shape)   # y shape: (1025,)
