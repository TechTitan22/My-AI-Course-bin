...
iris_data_return_X_y = load_iris( return_X_y= True)
"""(data, target)tuple if return_X_y is True
A tuple of two ndarrays by default. The first contains a 2D array of shape (150, 4) with each row representing one sample and each column representing the features. The second array of shape (150,) contains the target samples."""
print("iris_data_return_X_y :    ", iris_data_return_X_y)
print("iris_data_return_X_y[0] :    ", iris_data_return_X_y[0])
print("iris_data_return_X_y[1] :    ", iris_data_return_X_y[1])

iris_data_as_frame = load_iris(as_frame=True)
print("iris_data_as_frame", iris_data_as_frame )

# Convert data to pandas dataframe
iris_df = pd.DataFrame(iris_data.data, columns=iris_data.feature_names)

print("iris_df - dataFrame: ", iris_df)
...
# Take a preview
print("wine_df.head() : ", iris_df.head())


print(" wine_df.info() ", iris_df.info() )

print(" wine_df.describe()  ", iris_df.describe()  )


print("wine_df.tail()" , iris_df.tail() )
